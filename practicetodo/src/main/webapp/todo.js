...
function getTodos(){
    ...
    xhr.open("get","http://localhost:8080/todomvc/v1/api/todos");          
...
function updateTodo(id){
    ...
    xhr.open('PATCH','http://localhost:8080/todomvc/v1/api/todos');
...
function deleteTodo(id){
    let delTodo = {"id": id};
    let xhr = new XMLHttpRequest();
    xhr.open('DELETE','http://localhost:8080/todomvc/v1/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
...
function postTodo(todo){
    let xhr = new XMLHttpRequest();
    xhr.open('post','http://localhost:8080/todomvc/v1/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.onload = function(){
